...
/**
 * Validation tests for CreateStatusRequest
 */
@DisplayName("CreateStatusRequest class validation tests.")
public class CreateStatusRequestTests {
    ...
    void statusNameIsNullValidationFailedWithMessage() {
        CreateStatusRequest dto = new CreateStatusRequest(null, "some description", true, false,false,false, false);
        Set<ConstraintViolation<CreateStatusRequest>> violations = validator.validate(dto);
    ...
    void statusNameIsBlankValidationFailedWithMessage() {
        CreateStatusRequest dto = new CreateStatusRequest("", "some description", true, false,false,false, false);
        Set<ConstraintViolation<CreateStatusRequest>> violations = validator.validate(dto);
        String expectedMessage = messages.getString("status.name.notBlank");
    ...
    void statusNameIsMinLengthValidationFailedWithMessage() {
        CreateStatusRequest dto = new CreateStatusRequest("A", "some description", true, false,false,false, false);
        Set<ConstraintViolation<CreateStatusRequest>> violations = validator.validate(dto);
    ...
    void statusNameHasMoreThanMaxLengthValidationFailedWithMessage() {
        ...
        CreateStatusRequest dto = new CreateStatusRequest(categoryName, "some description", true, false,false,false,false);
        Set<ConstraintViolation<CreateStatusRequest>> violations = validator.validate(dto);
        String expectedMessage = messages.getString("status.name.length");
        assertThat(violations).hasSize(1);
        assertThat(violations)
    ...
    void createStatusRequestIsOk() {
        CreateStatusRequest request = new CreateStatusRequest("Open", "Hardware category for Incidents", true, false,false,false, false);
        Set<ConstraintViolation<CreateStatusRequest>> violations = validator.validate(request);
    ...
    void statusIsIncidentIsNullValidationFailedWithMessage() {
        CreateStatusRequest dto = new CreateStatusRequest("Open", "some description", null, false,false,false, false);
        Set<ConstraintViolation<CreateStatusRequest>> violations = validator.validate(dto);
    ...
    void statusIsProblemIsNullValidationFailedWithMessage() {
        CreateStatusRequest dto = new CreateStatusRequest("Open", "some description", false, null,false,false, false);
        Set<ConstraintViolation<CreateStatusRequest>> violations = validator.validate(dto);
    ...
    void statusIsRequestIsNullValidationFailedWithMessage() {
        CreateStatusRequest dto = new CreateStatusRequest("Open", "some description", false, false,null,false, false);
        Set<ConstraintViolation<CreateStatusRequest>> violations = validator.validate(dto);
    ...
    void statusIsChangeIsNullValidationFailedWithMessage() {
        CreateStatusRequest dto = new CreateStatusRequest("Open", "some description", false, false,false,null, false);
        Set<ConstraintViolation<CreateStatusRequest>> violations = validator.validate(dto);
    ...
    void statusIsTaskIsNullValidationFailedWithMessage() {
        CreateStatusRequest dto = new CreateStatusRequest("Open", "some description", false, false,false,false, null);
        Set<ConstraintViolation<CreateStatusRequest>> violations = validator.validate(dto);
