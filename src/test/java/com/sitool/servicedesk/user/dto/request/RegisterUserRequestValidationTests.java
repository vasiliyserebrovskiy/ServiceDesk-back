...
public class RegisterUserRequestValidationTests {
    ...
    */
    ...
    public void firstnameIsNullValidationFailedWithMessage() {
        RegisterUserRequest dto = new RegisterUserRequest(null, "Serebrovskii", "vasiliy@domain.com", "1qaZXsw@", "USER", "","");
    ...
    public void firstnameIsBlankValidationFailedWithMessage() {
        RegisterUserRequest dto = new RegisterUserRequest("", "Serebrovskii", "vasiliy@domain.com", "1qaZXsw@", "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
        String expectedMessage = messages.getString("user.firstname.notBlank");
    ...
    public void firstnameIsMinLengthValidationFailedWithMessage() {
        RegisterUserRequest dto = new RegisterUserRequest("A", "Serebrovskii", "vasiliy@domain.com", "1qaZXsw@", "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
    ...
    public void firstnameIsMaxLengthValidationFailedWithMessage() {
        ...
        RegisterUserRequest dto = new RegisterUserRequest(longName, "Serebrovskii", "vasiliy@domain.com", "1qaZXsw@", "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
        String expectedMessage = messages.getString("user.firstname.length");
        assertThat(violations).hasSize(1);
        assertThat(violations)
    ...
    public void lastnameIsNullValidationFailedWithMessage() {
        RegisterUserRequest dto = new RegisterUserRequest("Vasilii", null, "vasiliy@domain.com", "1qaZXsw@", "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
    ...
    public void lastnameIsBlankValidationFailedWithMessage() {
        RegisterUserRequest dto = new RegisterUserRequest("Vasilii", "", "vasiliy@domain.com", "1qaZXsw@", "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
        String expectedMessage = messages.getString("user.lastname.notBlank");
    ...
    public void lastnameIsMinLengthValidationFailedWithMessage() {
        RegisterUserRequest dto = new RegisterUserRequest("Vasilii", "S", "vasiliy@domain.com", "1qaZXsw@", "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
    ...
    public void lastnameIsMaxLengthValidationFailedWithMessage() {
        String longName = "a".repeat(101);
        RegisterUserRequest dto = new RegisterUserRequest("Vasilii", longName, "vasiliy@domain.com", "1qaZXsw@", "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
        String expectedMessage = messages.getString("user.lastname.length");
        assertThat(violations).hasSize(1);
        assertThat(violations)
    ...
    public void emailIsNullValidationFailedWithMessage() {
        RegisterUserRequest dto = new RegisterUserRequest("Vasilii", "Serebrovskii", null, "1qaZXsw@", "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
    ...
    public void emailIsBlankValidationFailedWithMessage() {
        RegisterUserRequest dto = new RegisterUserRequest("Vasilii", "Serebrovskii", "", "1qaZXsw@", "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
        String expectedMessage = messages.getString("user.email.notBlank");
    ...
    public void emailIsMinLengthValidationFailedWithMessage() {
        RegisterUserRequest dto = new RegisterUserRequest("Vasilii", "Serebrovskii", "a@b.ru", "1qaZXsw@", "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
    ...
    public void emailIsMaxLengthValidationFailedWithMessage() {
        ...
        RegisterUserRequest dto = new RegisterUserRequest("Vasilii", "Serebrovskii", longEmail, "1qaZXsw@", "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
        String expectedMessage = messages.getString("user.email.length");
        assertThat(violations).hasSize(1);
        assertThat(violations)
    ...
    public void emailHasTwoAtValidationFailedWithMessage() {
        RegisterUserRequest dto = new RegisterUserRequest("Vasilii", "Serebrovskii", "vasiliy@@domain.com", "1qaZXsw@", "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
    ...
    public void emailTopDomainLessThatTwoHyphenValidationFailedWithMessage() {
        RegisterUserRequest dto = new RegisterUserRequest("Vasilii", "Serebrovskii", "vasiliy@domain.c", "1qaZXsw@", "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
        String expectedMessage = messages.getString("user.email.validation");
        assertThat(violations).hasSize(1);
        assertThat(violations)
    ...
    public void emailTopDomainMoreThatSixHyphenValidationFailedWithMessage() {
        RegisterUserRequest dto = new RegisterUserRequest("Vasilii", "Serebrovskii", "vasiliy@domain.comcomv", "1qaZXsw@", "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
        String expectedMessage = messages.getString("user.email.validation");
        assertThat(violations).hasSize(1);
        assertThat(violations)
    ...
    public void passwordIsNullValidationFailedWithMessage() {
        RegisterUserRequest dto = new RegisterUserRequest("Vasilii", "Serebrovskii", "vasiliy@domain.com", null, "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
    ...
    public void passwordIsBlankValidationFailedWithMessage() {
        RegisterUserRequest dto = new RegisterUserRequest("Vasilii", "Serebrovskii", "vasiliy@domain.com", "", "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
        String expectedMessage = messages.getString("user.password.notBlank");
    ...
    public void passwordIsMinLengthValidationFailedWithMessage() {
        RegisterUserRequest dto = new RegisterUserRequest("Vasilii", "Serebrovskii", "vasiliy@domain.com", "1qXs@", "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
    ...
    public void passwordIsMaxLengthValidationFailedWithMessage() {
        ...
        RegisterUserRequest dto = new RegisterUserRequest("Vasilii", "Serebrovskii", "vasiliy@domain.com", longPassword, "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
        String expectedMessage = messages.getString("user.password.length");
        assertThat(violations).hasSize(1);
        assertThat(violations)
    ...
    public void passwordWithoutBigCharValidationFailedWithMessage() {
        RegisterUserRequest dto = new RegisterUserRequest("Vasilii", "Serebrovskii", "vasiliy@domain.com", "a1@sdf4g", "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
    ...
    public void passwordWithoutSpecialSymbolValidationFailedWithMessage() {
        RegisterUserRequest dto = new RegisterUserRequest("Vasilii", "Serebrovskii", "vasiliy@domain.com", "a1BsDf4g", "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
        String expectedMessage = messages.getString("user.password.validation");
        assertThat(violations).hasSize(1);
        assertThat(violations)
    ...
    public void passwordWithoutNumberValidationFailedWithMessage() {
        RegisterUserRequest dto = new RegisterUserRequest("Vasilii", "Serebrovskii", "vasiliy@domain.com", "a@BsDfcg", "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
        String expectedMessage = messages.getString("user.password.validation");
        assertThat(violations).hasSize(1);
        assertThat(violations)
    ...
    public void RegisterUserRequestIsOk() {
        RegisterUserRequest dto = new RegisterUserRequest("Vasilii", "Serebrovskii", "vasiliy.serebr@domain.com", "1qaZXsw@", "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
    ...
    public void RegisterUserRequestIsOk3() {
        RegisterUserRequest dto = new RegisterUserRequest("Vasilii", "Serebrovskii", "vasiliy-serebr@domain-domain.com", "1qaZXsw@", "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
        assertThat(violations).isEmpty();
    }
    ...
    public void RegisterUserRequestIsOk4() {
        RegisterUserRequest dto = new RegisterUserRequest("Vasilii", "Serebrovskii", "vasiliy_serebr.serebr@domain-domain.com", "1qaZXsw@", "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
        assertThat(violations).isEmpty();
    }
    ...
    public void RegisterUserRequestIsOk5() {
        RegisterUserRequest dto = new RegisterUserRequest("Vasilii", "Serebrovskii", "vasiliy123.serebr@123domain-domain.com", "1qaZXsw@", "USER", "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
        assertThat(violations).isEmpty();
    }

    /**
     * Test 31: Role is null
     */
    @Test
    @DisplayName("User role is null → validation test failed with message: User role can not be blank.")
    public void roleIsNullValidationFailedWithMessage() {
        RegisterUserRequest dto = new RegisterUserRequest("Vasilii", "Serebrovskii", "vasiliy@domain.com", "1qaZXsw@", null, "","");
        Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(dto);
        String expectedMessage = messages.getString("user.role.notBlank");
        assertThat(violations).hasSize(1);
        assertThat(violations)
    ...
    @Test
    @DisplayName("User role is null → validation test failed with message: User role can not be blank.")
    public void roleIsBlankValidationFailedWithMessage() {
