...
/**
 * Validation tests for ResetPasswordRequest
 */
@DisplayName("ResetPasswordRequest class validation tests.")
public class ResetPasswordRequestValidationTests {
    ...
    public void newPasswordIsNullValidationFailedWithMessage() {
        ResetPasswordRequest dto = new ResetPasswordRequest(null);
        Set<ConstraintViolation<ResetPasswordRequest>> violations = validator.validate(dto);
    ...
    public void newPasswordIsMinLengthValidationFailedWithMessage() {
        ResetPasswordRequest dto = new ResetPasswordRequest("1qXs@");
        Set<ConstraintViolation<ResetPasswordRequest>> violations = validator.validate(dto);
    ...
    public void newPasswordIsMaxLengthValidationFailedWithMessage() {
        ...
        ResetPasswordRequest dto = new ResetPasswordRequest(longPassword);
        Set<ConstraintViolation<ResetPasswordRequest>> violations = validator.validate(dto);
        String expecterMessage = messages.getString("user.password.length");
        assertThat(violations).hasSize(1);
        assertThat(violations)
    ...
    public void newPasswordWithoutBigCharValidationFailedWithMessage() {
        ResetPasswordRequest dto = new ResetPasswordRequest("a1@sdf4g");
        Set<ConstraintViolation<ResetPasswordRequest>> violations = validator.validate(dto);
    ...
    public void newPasswordWithoutSpecialSymbolValidationFailedWithMessage() {
        ResetPasswordRequest dto = new ResetPasswordRequest("a1BsDf4g");
        Set<ConstraintViolation<ResetPasswordRequest>> violations = validator.validate(dto);
        String expecterMessage = messages.getString("user.password.validation");
        assertThat(violations).hasSize(1);
        assertThat(violations)
    ...
    public void newPasswordWithoutNumberValidationFailedWithMessage() {
        ResetPasswordRequest dto = new ResetPasswordRequest("a@BsDfcg");
        Set<ConstraintViolation<ResetPasswordRequest>> violations = validator.validate(dto);
        String expecterMessage = messages.getString("user.password.validation");
        assertThat(violations).hasSize(1);
        assertThat(violations)
    ...
    public void ChangePasswordRequestIsOk() {
        ResetPasswordRequest dto = new ResetPasswordRequest("P@ssw0rd");
        Set<ConstraintViolation<ResetPasswordRequest>> violations = validator.validate(dto);
