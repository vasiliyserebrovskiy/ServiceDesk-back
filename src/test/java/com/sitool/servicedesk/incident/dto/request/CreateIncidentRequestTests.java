...
/**
 * Validation tests for CreateIncidentRequest
 */
@DisplayName("CreateIncidentRequest class validation tests.")
public class CreateIncidentRequestTests {
    ...
    void incidentNumberIsNullValidationFailedWithMessage() {
        CreateIncidentRequest dto = new CreateIncidentRequest(
                null,
                UUID.randomUUID(),
                UUID.randomUUID(),
                UUID.randomUUID(),
