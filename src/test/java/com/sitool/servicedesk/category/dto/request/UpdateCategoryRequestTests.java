...
/**
 * Validation tests for UpdateCategoryRequest
 */
@DisplayName("UpdateCategoryRequest class validation tests.")
public class UpdateCategoryRequestTests {
    ...
    void categoryNameIsNullValidationFailedWithMessage() {
        UpdateCategoryRequest dto = new UpdateCategoryRequest(null, "some description", true, false,false,false);
        Set<ConstraintViolation<UpdateCategoryRequest>> violations = validator.validate(dto);
    ...
    void categoryNameIsBlankValidationFailedWithMessage() {
        UpdateCategoryRequest dto = new UpdateCategoryRequest("", "some description", true, false,false,false);
        Set<ConstraintViolation<UpdateCategoryRequest>> violations = validator.validate(dto);
        String expectedMessage = messages.getString("category.name.notBlank");
    ...
    void categoryNameIsMinLengthValidationFailedWithMessage() {
        UpdateCategoryRequest dto = new UpdateCategoryRequest("A", "some description", true, false,false,false);
        Set<ConstraintViolation<UpdateCategoryRequest>> violations = validator.validate(dto);
    ...
    void categoryNameHasMoreThanMaxLengthValidationFailedWithMessage() {
        ...
        UpdateCategoryRequest dto = new UpdateCategoryRequest(categoryName, "some description", true, false,false,false);
        Set<ConstraintViolation<UpdateCategoryRequest>> violations = validator.validate(dto);
        String expectedMessage = messages.getString("category.name.length");
        assertThat(violations).hasSize(1);
        assertThat(violations)
    ...
    void createCategoryRequestIsOk() {
        UpdateCategoryRequest request = new UpdateCategoryRequest("Hardware", "Hardware category for Incidents", true, false,false,false);
    ...
    void categoryIsIncidentIsNullValidationFailedWithMessage() {
        UpdateCategoryRequest dto = new UpdateCategoryRequest("Hardware", "some description", null, false,false,false);
        Set<ConstraintViolation<UpdateCategoryRequest>> violations = validator.validate(dto);
    ...
    void categoryIsProblemIsNullValidationFailedWithMessage() {
        UpdateCategoryRequest dto = new UpdateCategoryRequest("Hardware", "some description", true, null,false,false);
        Set<ConstraintViolation<UpdateCategoryRequest>> violations = validator.validate(dto);
    ...
    void categoryIsRequestIsNullValidationFailedWithMessage() {
        UpdateCategoryRequest dto = new UpdateCategoryRequest("Hardware", "some description", true, false,null,false);
        Set<ConstraintViolation<UpdateCategoryRequest>> violations = validator.validate(dto);
    ...
    void categoryIsChangeIsNullValidationFailedWithMessage() {
        UpdateCategoryRequest dto = new UpdateCategoryRequest("Hardware", "some description", true, false,false,null);
        Set<ConstraintViolation<UpdateCategoryRequest>> violations = validator.validate(dto);
