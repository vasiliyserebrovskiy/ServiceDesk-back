...
/**
 * Validation tests for CreateSubcategoryRequest
 */
@DisplayName("CreateSubcategoryRequest class validation tests.")
public class CreateSubcategoryRequestTests {
    ...
    void subcategoryNameIsNullValidationFailedWithMessage() {
        ...
        CreateSubcategoryRequest dto = new CreateSubcategoryRequest(null, "some description", categoryId);
        Set<ConstraintViolation<CreateSubcategoryRequest>> violations = validator.validate(dto);
    ...
    void subcategoryNameIsBlankValidationFailedWithMessage() {
        UUID categoryId = UUID.randomUUID();
        CreateSubcategoryRequest dto = new CreateSubcategoryRequest("", "some description", categoryId);
        Set<ConstraintViolation<CreateSubcategoryRequest>> violations = validator.validate(dto);
        String expectedMessage = messages.getString("subcategory.name.notBlank");
    ...
    void categoryNameIsMinLengthValidationFailedWithMessage() {
        UUID categoryId = UUID.randomUUID();
        CreateSubcategoryRequest dto = new CreateSubcategoryRequest("A", "some description", categoryId);
        Set<ConstraintViolation<CreateSubcategoryRequest>> violations = validator.validate(dto);
    ...
    void categoryNameHasMoreThanMaxLengthValidationFailedWithMessage() {
        ...
        CreateSubcategoryRequest dto = new CreateSubcategoryRequest(subcategoryName, "some description", categoryId);
        Set<ConstraintViolation<CreateSubcategoryRequest>> violations = validator.validate(dto);
        String expectedMessage = messages.getString("subcategory.name.length");
        assertThat(violations).hasSize(1);
        assertThat(violations)
    ...
    void createCategoryRequestIsOk() {
        UUID categoryId = UUID.randomUUID();
        CreateSubcategoryRequest request = new CreateSubcategoryRequest("CPU", "CPU subcategory", categoryId);
        Set<ConstraintViolation<CreateSubcategoryRequest>> violations = validator.validate(request);
    ...
    void subcategoryCategoryIdIsNullValidationFailedWithMessage() {
        ...
        CreateSubcategoryRequest dto = new CreateSubcategoryRequest("CPU", "some description", null);
        Set<ConstraintViolation<CreateSubcategoryRequest>> violations = validator.validate(dto);
